    ...
    return(
      <Modal
          ...
          <View style={styles.contentWrapper}>
            ...
            <TextButton name="CLOSE" callback={this._onClose} />
            <View style={{height:20}} />
            <Minus99MultipleSelect name="Status" items={this.items} />
            <Minus99MultipleSelect name="Account Manager" items={this.items2} />
